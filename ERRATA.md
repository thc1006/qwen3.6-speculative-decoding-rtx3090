...
`27dd6ac3d98e`, all **2 446** numbers across all **128** tables were perturbed
...
reports: **32 shards, one head `27dd6ac3d98e`, one checker `d5193848d7a0`, 2 446 locations covered exactly once, 0 survived**. Covered *exactly once* is the part the earlier sentence
