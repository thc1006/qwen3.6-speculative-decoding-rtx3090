...
`ecc29db88319`, all **2 446** numbers across all **128** tables were perturbed
...
reports: **32 shards, one head `ecc29db88319`, one checker `d5193848d7a0`, 2
...
sit **2 641** whole numbers, **358** of which are not a string literal in the
