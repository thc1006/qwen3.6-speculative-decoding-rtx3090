...
- **Published tables were computed and asserted while the tables themselves were
  ...
  parsed tables of commit `ecc29db88319` and caught every one, in 32 shards
...
`ecc29db88319`, one checker `d5193848d7a0`, 2 446 locations covered exactly
...
python -m unittest discover tests         # 373 regressions for defects shipped here
