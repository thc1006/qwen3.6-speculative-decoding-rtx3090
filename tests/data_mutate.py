...
MUTATIONS = [
    ...
    ("replication table: O3's DFlash figure becomes +24.4 %",
     edit_doc("v4_audit_2026_08_25/README.md", "| +26.3 % | **+23.4 %** | **\u22122.9 pp** |",
              "| +26.3 % | **+24.4 %** | **\u22122.9 pp** |")),
    ("replication table: a shift becomes -1.0 pp",
     edit_doc("v4_audit_2026_08_25/README.md", "| +22.7 % | +21.7 % | \u22121.0 pp |",
              "| +22.7 % | +21.7 % | \u22122.0 pp |")),
    ("footnote: run M1's figure becomes +27.7 %",
     edit_doc("v4_audit_2026_08_25/README.md", "M1 **+26.7 %** 07:59", "M1 **+27.7 %** 07:59")),
    ("footnote: a run's clock time is wrong by a minute",
     edit_doc("v4_audit_2026_08_25/README.md", "O3 **+23.4 %** 20:44", "O3 **+23.4 %** 20:45")),
    ("footnote: run U3's figure becomes +19.3 %",
     edit_doc("v4_audit_2026_08_25/README.md", "U3 **+17.3 %** 22:18", "U3 **+19.3 %** 22:18")),
    ...
    ("README cost table: the restore share goes back to 30.5 %",
     edit_doc("v4_audit_2026_08_25/README.md", "| 21.74 | 30.4 % |", "| 21.74 | 30.5 % |")),
    ("README cost table: the drafter's seconds become 19.27",
     edit_doc("v4_audit_2026_08_25/README.md", "| drafter `generate()` | 17.27 |",
    ...
    ("the README and A10 p_min tables disagree",
     edit_doc("v4_audit_2026_08_25/README.md", "| `n_max` 8, `p_min` 0.90 | **88.2 %** | 42.5 | \u221265.6 % |",
