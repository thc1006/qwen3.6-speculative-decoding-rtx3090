...
| M1, M2, M3, M4, N, O, **O2**, O3, P, Q, R, T, T3, U1, U2, U3, U4, U5, U6, V, **V2**, **V3**, **T4** | unset (`-fit on`) | 8192 | 3072 | 2048 still leaves the DFlash arm inside 630 MiB of headroom; 3072 is where every arm of the nine-method matrix starts reliably |
